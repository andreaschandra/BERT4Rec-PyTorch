...
parser.add_argument('--dataset_code', type=str,
                    default='ml-1m', choices=DATASETS.keys())
...
parser.add_argument('--train_negative_sampling_seed', type=int, default=42)
...
parser.add_argument('--test_negative_sampling_seed', type=int, default=42)
...
parser.add_argument('--model_init_seed', type=int, default=42,
                    help='set seed')
# BERT #
parser.add_argument('--bert_max_len', type=int, default=32,
                    help='Length of sequence for bert')
parser.add_argument('--bert_num_items', type=int, default=3533,
...
parser.add_argument('--bert_num_heads', type=int, default=1,
